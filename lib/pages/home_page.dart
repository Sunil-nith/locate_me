    ...
    return Scaffold(
      ...
      body: PopScope(
        ...
        child: FutureBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot<Box<TripLocationData>> snapshot) {
                          ...
                          children: <Widget>[
                            Center(
                              child: ElevatedButton(
                                onPressed: () {
                                  String? userId = ref.read(authProvider).currentUserPhone;
                                  ref.read(locationProvider.notifier).startTracking(userId!);
                                },
                            ...
                            Center(
                              child: ElevatedButton(
                                onPressed: () =>
                                    ref.read(locationProvider.notifier).stopTracking(context),
                                style: ElevatedButton.styleFrom(
                            ...
                            const SizedBox(height: 20),
                            if (locationState.trackingStatus.isNotEmpty)
                              Text(
                            ...
                            const SizedBox(height: 20),
                            if (locationState.startLocData != null &&
                                locationState.endLocData != null)
                              Card(
                                elevation: 3.0,
                                child: Padding(
      ...
      floatingActionButton: ElevatedButton(
        onPressed: () => ref.read(locationProvider.notifier).continueToSecondScreen(context),
        style: ElevatedButton.styleFrom(
